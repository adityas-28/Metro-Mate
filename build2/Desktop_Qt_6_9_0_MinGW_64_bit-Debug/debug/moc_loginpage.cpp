...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::goBackToWelcomePage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::loginSuccess, 1))
            return;
    }
}
